...
export default function About() {
    ...
    return (
        <>
            <main className='about w-screen bg-gray-800 flex flex-col justify-evenly items-center'>
                <section className='about-me  w-11/12'>
                    <h1 className='p-2 mb-4 text-gray-300 font-CustomFont1 text-2xl underline underline-offset-4 decoration-pink-500 text-center'>About Me</h1>
