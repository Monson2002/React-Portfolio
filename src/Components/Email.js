        ...
        <form ref={form} onSubmit={sendEmail} className='flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-col justify-center items-stretch'>
                ...
                <div className='m-auto flex justify-center items-center'>
                    <textarea required className='p-1 rounded text-slate-800 text-sm w-10/12' name="message" rows={5} cols={40} />
                </div>
            </div>
            <div className='flex justify-center items-center'>
                <button className="bg-transparent hover:bg-blue-500 font-semibold text-xs text-slate-800 bg-slate-200 hover:text-white p-2 m-4 border border-blue-500 hover:border-transparent rounded">
