    ...
    return (
        <form ref={form} onSubmit={sendEmail} className='flex flex-col justify-center items-center'>
            ...
            <div className='flex justify-center items-center w-10/12 sm:m-1 '>
                ...
                <input required className='p-1 rounded text-slate-800 text-sm w-10/12 group-hover:border-solid border-2 border-sky-500   ' type="text" name="user_name" />
            </div>
            <div className='flex justify-center items-center w-10/12 sm:m-1 '>
                <label className='text-gray-300 font-CustomFont1 p-2  '>
                    Email
                </label>
                <input required className='p-1 rounded text-slate-800 text-sm w-10/12 group-hover:border-solid border-2 border-sky-500' type="email" name="user_email" />
            </div>
            <div className='flex flex-col justify-center items-stretch w-full sm:m-1 sm:w-3/4'>
                ...
                <div className='m-auto flex justify-center items-center w-full sm:w-full'>
                    <textarea required className='p-1 rounded text-slate-800 text-sm w-10/12 sm:w-full group-hover:border-solid border-2 border-sky-500' name="message" rows={5} />
                </div>
            </div>
