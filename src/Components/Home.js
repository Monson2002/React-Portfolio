            ...
            <main className='home h-screen w-screen bg-cover bg-fixed flex flex-col justify-between items-center' id='home'>
                ...
                <div className='container p-2 sm:w-3/5 md:mt-7 lg:w-2/5'>
                    ...
                    <div className='flex items-center justify-center lg:mt-4'>
                        <button onClick={()=>{window.open("https://drive.google.com/file/d/1yTBNZzrKWsTqUNLrQY-J1_cO5vOpDTFI/view?usp=sharing");}} className="w-auto m-2 sm:m-4 p-1 py-2 sm:py-3 font-medium text-gray-900 rounded-lg group bg-transparent border hover:text-white dark:text-white">
