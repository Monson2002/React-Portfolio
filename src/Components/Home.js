                    ...
                    <div className='dropdown-md hidden md:flex'>
                        <div className='dropdown'>
                            <ul className="text-gray-300 flex justify-center items-center md:mx-2 rounded-lg">
                                <a href="#home"><li className="p-2 m-1 w-auto text-lg font-normal hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100" onClick={toggleNavbar}>Home</li></a>
                                <a href="#about"><li className="p-2 m-1 w-auto text-lg font-normal hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100" onClick={toggleNavbar}>About</li></a>
                                <a href="#projects"><li className="p-2 m-1 w-auto text-lg font-normal hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100" onClick={toggleNavbar}> Projects</li></a>
                                <a href="#contact-us"><li className="p-2 m-1 w-auto text-lg font-normal hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100" onClick={toggleNavbar}> Contact</li></a>
                            </ul>
                        </div>
                    </div>
